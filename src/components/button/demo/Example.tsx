...
const Example = () => (
  <>
    ...
    <Button type="ghost" inline className="button-example-space">button inline ghost</Button>
    <Button type="primary" inline round size="small" className="button-example-space">inline primary small button</Button>
