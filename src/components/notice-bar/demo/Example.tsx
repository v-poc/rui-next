...
const Example = () => {
  ...
  return (
    <>
      <Divider contentAlign="left">NoticeBar types</Divider>
      <NoticeBar content="Default type of NoticeBar" />
      <br />
      <NoticeBar type="alert" content="Alert type of NoticeBar" />
      <br />
      <NoticeBar type="error" content="Error type of NoticeBar" />
      <br />
